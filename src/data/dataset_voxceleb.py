...
class VoxCelebSpecDatasetTypeA(Dataset):
    def __init__(self, file_path: str, audio_window=20480, sample_rate=16000, full_audio=False, augmentation=False,
                 speaker_filelist="./dataset/voxceleb01-SI-label.txt", config=None, augmentation_count=None):
        super(VoxCelebSpecDatasetTypeA, self).__init__()
